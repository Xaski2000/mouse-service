...
function openForm() {
	...
	myForm.classList.add('form-popup-class');
	document.getElementById("bg-form").style.display = "block";
	//document.getElementById("form-open-button").style.display = "none";
	document.body.classList.add('stop-scrolling');
}

function closeForm() {
    document.getElementById("myForm").style.display = "none";
	document.getElementById("form-open-button").style.display = "block";
...
//   var new_height = document.body.offsetHeight - document.getElementById("head").offsetHeight -
//   document.getElementById("footer").offsetHeight - 44 + "px";
